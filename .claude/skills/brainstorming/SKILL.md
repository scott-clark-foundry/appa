...
- Notify the user that the next step is to invoke the writing-plans skill to create a detailed implementation plan

## Key Principles

- **Use the AskUserQuestion tool** for all questions to the user, even clarifying ones. This ensures they see and can respond to each question.
